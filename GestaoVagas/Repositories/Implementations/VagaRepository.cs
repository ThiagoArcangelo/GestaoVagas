...
public class VagaRepository : IVagasRepository
{
    ...
    public async Task<IEnumerable<VagasModel>> GetAll()
    {
        IEnumerable<VagasModel> vagas;
        ...
        try
        {
            ...
            vagas = await con.QueryAsync<VagasModel>(sql.ToString());
    ...
    public async Task<VagasModel> GetById(int id)
    {
        VagasModel vagas = new();
    ...
    public async Task<bool> Add(VagasModel entity)
    {
        bool retorno = false;
    ...
    public async Task<bool> Update(VagasModel entity)
    {
        bool retorno = false;
